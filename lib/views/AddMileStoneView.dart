...
import 'package:parenthood/widget/milestone_widget.dart';
...
class AllMilstoneView extends StatefulWidget {
  const AllMilstoneView({Key? key}) : super(key: key);

  @override
  AllMilstoneViewState createState() => AllMilstoneViewState();
...
class AllMilstoneViewState extends State<AllMilstoneView> {
  TextEditingController titleController = TextEditingController();
  TextEditingController descriptionController = TextEditingController();
  TextEditingController dateController = TextEditingController();
  TextEditingController timeController = TextEditingController();

  final MilestoneWidget MilestoneManager = MilestoneWidget();
  ...
  Future<List<String>> fetchIcons() async {
    final QuerySnapshot querySnapshot = await _firestore.collection('milstoneicons').get();
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: const Text('Milstones'),
                      onTap: () {
                        Get.to(AllMilstoneView());
                      },
                    ),
                    ListTile(
      ...
      body: Stack(
        children: [
          ...
          FutureBuilder<Widget>(
            future: MilestoneWidgetManager().milestoneWidget(context, startDate, endDate),
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          todoDatabase
                            ...
                            Get.snackbar('Success', 'Milestone added successfully',
                            ...
                            Get.snackbar(
                                'Error adding a Milestone', 'Milestone not added',
                                snackPosition: SnackPosition.BOTTOM,
