...
import 'package:parenthood/views/AddMileStoneView.dart';
...
class TodoViewState extends State<TodoView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            onPressed: () {
              ...
              Get.to(Drawer(
                // backgroundColor:
                // Get.isDarkMode ? ThemeData.dark().primaryColorDark : Colors.grey,
                child: ListView(
      ...
      drawer: Drawer(
        backgroundColor:
            Get.isDarkMode ? ThemeData.dark().primaryColor : Colors.white,
        child: ListView(
          padding: const EdgeInsets.only(top: 20),
          children: [
            //Drawerheader
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            todoDatabase
                                .addData(
                                    ...
                                    descriptionController.text ?? "No description",
                                    dateController.text,
                                    timeController.text,
                                    _selectedIconUrl ?? "https://firebasestorage.googleapis.com/v0/b/parenthoodapp-flutter-db.appspot.com/o/orange.png?alt=media&token=92ebd10b-55a4-4c0b-abe8-615c44515e4f",
